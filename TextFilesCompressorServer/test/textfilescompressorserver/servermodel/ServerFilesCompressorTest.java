 ...
 */
public class ServerFilesCompressorTest {
    /**
    ...
    public ServerFilesCompressorTest() {
        
        ServerFilesCompressorTest.fileToCompressName = "test.txt";
        ServerFilesCompressorTest.compressedOutFileName = "out.txt";
        ServerFilesCompressorTest.fileToDecompressName = "out.txt";
        ServerFilesCompressorTest.decompressedOutFileName = "decompressed.txt";
    }
    
    @Before
    public void setUp() {
        
        compressor = new ServerFilesCompressor(fileToCompressName, "", compressedOutFileName);
        decompressor = new ServerFilesCompressor("", fileToDecompressName, decompressedOutFileName);  
    }
    ...
    public void testCompressFileWithNonExistentFile() throws IOException {
        ...
        CompressorInterface compressor = new ServerFilesCompressor("nonexistentfile.txt", "", compressedOutFileName);
    ...
    public void testDecompressFileWithNonExistentFile() throws IOException {
        ...
        CompressorInterface decompressor = new ServerFilesCompressor("", "nonexistentfile.txt", decompressedOutFileName);
    ...
    public void testCompressFileWithNullFileName() throws IOException {
        ...
        CompressorInterface compressor = new ServerFilesCompressor(null, "", compressedOutFileName);
    ...
    public void testDecompressFileWithNullFileName() throws IOException {
        ...
        CompressorInterface decompressor = new ServerFilesCompressor("", null, decompressedOutFileName);
